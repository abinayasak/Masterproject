...
def fitzhugh_nagumo(v, t):
    ...
    return np.vstack((dVdt,dWdt))

t = np.linspace(1, 100, N)

initial_values = np.vstack((v0,w0))
#print(initial_values.shape)
#print(initial_values)

values = odeint(fitzhugh_nagumo, initial_values, t)

plt.plot(t, values[0], label="v")
plt.plot(t, values[1], label="w")
plt.legend()
