...
class CardiacModel(object):
    ...
    *Arguments*
    ...
    def __init__(self, subdomain, domain, time, M_i, M_e, cell_models,
        ...
        plt.savefig("plots/cardiacmodels_init.png")
    ...
    def _handle_input(self, subdomain, domain, time, M_i, M_e, cell_models,
        ...
        plot(stimulus.markers())
        plt.savefig("plots/cardiacmodels_before_markerwise.png")
        for v in stimulus.values():
            plot(v, mesh=domain)
            plt.savefig("plots/cardiacmodels_before_markerwise_2.png")
        ...
        plot(self._stimulus.markers())
        plt.savefig("plots/cardiacmodels_after_markerwise.png")
